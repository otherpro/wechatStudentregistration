...
Page({
      ...
      save: function() {
        ...
        util.post(api.CourseSelectUpdate, { data})
          .then(function(res) {
            if (res.errno == 0) {
              wx.showModal({
                title: '保存信息',
      ...
      bindRoomChange: function(e) {
        this.setData({
          ...
          'currentCategory.room': this.data.room[e.detail.value],
        })
      },
      bindCreditChange: function(e) {
        this.setData({
          indexCredit: e.detail.value,
          'currentCategory.credit': ++e.detail.value,
        })
      },
      bindMultiPickerChange: function(e) {
        this.setData({
            multiIndex: e.detail.value,
            'currentCategory.week': this.data.multiArray[0][e.detail.value[0]],
            'currentCategory.lesson': this.data.multiArray[1][e.detail.value[1]] + this.data.multiArray[2][e.detail.value[2]],
            })
          },
          sliderchange: function(e) {
            this.setData({
              'currentCategory.maxNum': e.detail.value,
            })
          },
        })